    <div
        class="flex flex-col w-64 @if (Auth::user()->role_id === 1)
        h-full
        @else
        h-screen
    @endif pb-8 bg-gray-800 border-r dark:bg-gray-800 dark:border-gray-600">

        <div class="mt-3 mb-5 justify-between flex">
            <div class="ml-2">
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <a class="flex logout__text text-blue-400 hover:text-blue-200" href="route('logout')"
            ...
            <div>
                <a class="logout__text text-blue-400 hover:text-blue-200 mr-2" href="/">Web Site</a>
            </div>
        </div>

        <h2 class="text-3xl font-semibold text-center text-gray-400 dark:text-white">Google</h2>
