    ...
    <section class="flex">
        ...
        <section class="w-full h-full mt-8">
            ...
            <section class="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
                <h2 class="text-lg font-semibold text-gray-700 capitalize dark:text-white">Add a category</h2>
            ...
            <section>
                <h1 class="text-center text-3xl mt-8 text-gray-700">Available Categories</h1>
